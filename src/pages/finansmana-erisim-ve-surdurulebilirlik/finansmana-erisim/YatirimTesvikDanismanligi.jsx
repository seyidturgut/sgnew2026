...
const YatirimTesvikDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Yatırım Teşvik Danışmanlığı", "href": null}]
...
export default YatirimTesvikDanismanligi
