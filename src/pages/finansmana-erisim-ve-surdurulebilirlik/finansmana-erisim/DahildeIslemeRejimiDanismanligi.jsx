...
const DahildeIslemeRejimiDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Dahilde İşleme Rejimi Nedir?", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="Dahilde İşleme Rejimi Nedir?"
            titleHighlighted=""
...
export default DahildeIslemeRejimiDanismanligi
