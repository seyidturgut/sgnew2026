...
const OutsourceBordroYonetimi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Outsource Bordro", "href": null}]
...
export default OutsourceBordroYonetimi
