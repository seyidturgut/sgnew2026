...
const KurumlarVeGelirVergisiTasdiki = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Kurumlar ve Gelir Vergisi", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="Kurumlar ve Gelir Vergisi"
            titleHighlighted=""
...
export default KurumlarVeGelirVergisiTasdiki
