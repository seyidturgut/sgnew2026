...
const IhracatDanismanligiVeIhracataBaslangic = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "İhracata Başlangıç Danışmanlığı Nedir?", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="İhracata Başlangıç Danışmanlığı Nedir?"
            titleHighlighted=""
...
export default IhracatDanismanligiVeIhracataBaslangic
