...
const PazarAnaliziVeHedefPazarTespiti = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Pazar Analizi ve Hedef Pazar Tespiti", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="Pazar Analizi ve Hedef Pazar Tespiti"
            titleHighlighted=""
...
export default PazarAnaliziVeHedefPazarTespiti
