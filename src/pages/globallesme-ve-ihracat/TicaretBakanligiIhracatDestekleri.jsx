...
const TicaretBakanligiIhracatDestekleri = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Ticaret Bakanlığı Destekleri", "href": null}]
...
export default TicaretBakanligiIhracatDestekleri
