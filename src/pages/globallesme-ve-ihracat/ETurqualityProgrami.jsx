...
const ETurqualityProgrami = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "E-Turquality Programı Nedir?", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="E-Turquality Programı Nedir?"
            titleHighlighted=""
...
export default ETurqualityProgrami
