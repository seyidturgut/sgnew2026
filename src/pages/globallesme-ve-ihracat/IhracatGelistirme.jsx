...
const IhracatGelistirme = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "İhracat Geliştirme Danışmanlığı", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="İhracat Geliştirme Danışmanlığı"
            titleHighlighted=""
...
export default IhracatGelistirme
