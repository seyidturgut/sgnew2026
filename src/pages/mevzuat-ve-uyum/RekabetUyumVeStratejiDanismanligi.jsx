...
const RekabetUyumVeStratejiDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Rekabet Uyum ve", "href": null}]
...
export default RekabetUyumVeStratejiDanismanligi
