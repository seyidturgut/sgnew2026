...
const ArGeYonetimiVeYasalCerceveyeUyumDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Ar-Ge Yönetimi", "href": null}]
...
export default ArGeYonetimiVeYasalCerceveyeUyumDanismanligi
