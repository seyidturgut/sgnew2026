...
const PayDevriVePaySahipligiSozlesmeleriDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Pay Devri ve Pay Sahipliği", "href": null}]
    ...
    return (
        <ServicePageLayout
            ...
            title="Pay Devri ve Pay Sahipliği"
            titleHighlighted=""
...
export default PayDevriVePaySahipligiSozlesmeleriDanismanligi
