...
const SirketKurmaTtkUygulamaVeSicilIsleriDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Şirket Kurma,", "href": null}]
...
export default SirketKurmaTtkUygulamaVeSicilIsleriDanismanligi
