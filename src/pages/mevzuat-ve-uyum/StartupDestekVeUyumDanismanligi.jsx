...
const StartupDestekVeUyumDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Startup Destek ve", "href": null}]
...
export default StartupDestekVeUyumDanismanligi
