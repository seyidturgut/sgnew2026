...
const KisiselVeriYonetimiVeUyumDanismanligi = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Kişisel Veri Yönetimi", "href": null}]
...
export default KisiselVeriYonetimiVeUyumDanismanligi
