...
const AileAnayasasiVeKurumsallasmaHizmetleri = () => {
    const breadcrumb = [{"label": "Anasayfa", "href": "/"}, {"label": "Aile Anayasası ve", "href": null}]
...
export default AileAnayasasiVeKurumsallasmaHizmetleri
